<template>
  <section class="grid gap-8 grid-cols-2">
    <v-card :to="`/`" class="h-full" v-for="n in 5" :key="n">
      <div class="-mx-4 -mt-4 mb-4 relative pb-2/3">
        <img
          :src="getSrc()"
          class="rounded-b-none h-full w-full object-cover"
        />
      </div>
      <h3 class="font-bold text-sm">Risk management při Margin tradingu</h3>
      <div class="text-gray-600 text-xs fill-current leading-6">
        <div class="mt-3 inline-flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="h-4 mr-2 inline-flex"
          >
        ...
        <div class="mt-2 inline-flex items-center">
          ...
          <span>nám. Winstona Churchilla 1938/4, Praha</span>
        </div>
      </div>
    </v-card>
  </section>
...
export default {
  ...
  methods: {
    getSrc() {
      const items = [
        "https://klubinvestoru.com/image/4205.jpeg",
        "https://klubinvestoru.com/image/4206.jpeg",
        "https://klubinvestoru.com/image/4207.jpeg",
        "https://klubinvestoru.com/image/4208.jpeg"
      ];
