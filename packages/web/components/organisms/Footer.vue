<template>
  <footer
    class="mt-32 bg-gray-800 text-gray-200 fill-current flex justify-between items-center py-16"
  >
    <div
      class="w-10/12 md:container mx-auto grid gap-12 md:flex justify-between items-center"
    >
      <section>
